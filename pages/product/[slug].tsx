...
export default function Post ({addToCart}:any) {
  ...
  <div className="container px-5 py-14 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto  object-cover object-center rounded" src="https://m.media-amazon.com/images/I/61hh8wS16wL._UY879_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex ">
          ...
          <button className="flex ml-auto text-white bg-pink-500 border-0 py-2 px-3 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
          <button className="flex ml-auto text-white bg-pink-500 border-0 py-2 px-3 focus:outline-none hover:bg-pink-600 rounded" onClick={()=>{addToCart(slug,1,99,"name","XL","red")}}>Add to Cart</button>
        ...
        <div className=' pin mt-20 flex space-x-2 justify-between text-sm'>
        <input type="text" name="pincode" placeholder='341516' id="pincode" className='px-2 py-2 border-2
        border-pink-200 outline-0 rounded-md' onChange={toogleChange}/>
