...
export default function Banner() {
  ...
  return (
    ...
    <div className={` bg-[url('/banner.png')] lg:bg-[url('/bannerlg.png')] lg:bg-cover  bg-contain bg-no-repeat md:h-[30rem] sm:h-[25rem] h-[20rem]  `}>
      <div className={`md:w-[28rem] w-[21rem] sm:justify-center   pl-8 pt-8 md:pl-16  lg:pl-56 lg:pt-28 md:pt-20 flex justify-start  flex-col `}>
        ...
        <div className='text-sm font-serif sm:pt-6 md:text-2xl sm:w-full w-52'>
